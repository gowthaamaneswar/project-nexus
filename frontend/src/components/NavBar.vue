<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo"><img src="../assets/images/taco-logo.png" alt="" />INDIAN MEXICAN
        </router-link>

        <nav class="navbar">
            <router-link @click="scrollToTop()" to="/"><b>home</b></router-link>
            <router-link @click="scrollToTop()" to="/about"><b>about</b></router-link>
            <router-link @click="scrollToTop()" to="/promotions"><b>promotions</b></router-link>
            <router-link @click="scrollToTop()" to="/menu"><b>menu</b></router-link>
            <router-link @click="scrollToTop()" to="/table"><b>table</b></router-link>
        </nav>
